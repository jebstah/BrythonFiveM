...
setmetatable(Player, {
    __call = function(self, source, permission_level, money, bank, identifier, group)
      local pl = {}
...
-- Set bank balance
function Player:setBankBalance(a)
  TriggerEvent("es:setPlayerData", self.source, "bank", a, function(response, success)
      self.bank = a
    end)
end
